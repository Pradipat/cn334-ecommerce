    ...
    <div className="text-black flex flex-col justify-center w-max items-center">
        ...
        <div className="flex flex-col mt-[50px]">
            <form className="flex flex-col gap-3">
                ...
                <input className="w-[343px] mt-[50px] h-[48px] bg-[#6c6c6c] rounded-[5px] flex text-white justify-center items-center " type="submit" defaultValue="SignUp"/>
            </form>
        </div>
        <div className="flex gap-2 text-[#595959] font-light text-[15px] mt-4 w-max">
                    <div>New to EduProtal?</div>
                    <div className="underline">Sign up now</div>
        </div>
    </div>
  )
}
