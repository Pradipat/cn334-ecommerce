...
export default function categoryCard({ title, teacherName, teacherRole, imageSource, status, id }) {
  return (
      <Link href={`/products/${id}`}>
        <div className={`card-container rounded-[16px] flex w-full h-[142px]  md:h-[23.8rem] md:w-[32%] lg:h-[381px] lg:w-[352px] md:flex-col mb-3.5 md:mb-6 md:rounded-[16px] md:overflow-hidden md:bg-[#252525]`}>
            ...
            <div className='flex flex-col justify-start ml-4 my-4 md:mx-4 md:my-0 md:h-[calc(100%-220px)] md:justify-start pt-[22px]'>
