...
function smallCard({ title, teacherRole, teacherName, imageSource, hover, handleHoverIn, handleHoverOut, id}) {
  return (
        ...
        >
            ...
            <div className='flex flex-col justify-center'>
                ...
                <div className={`text-xs font-extralight md:text-sm text-[#A0A0A0]`}>{teacherRole}, {teacherName}</div>
            </div>
        </Link>
  )
}
